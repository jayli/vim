...
" ====================
if !exists("g:did_vim_syntax_inits")
  let g:did_vim_syntax_inits = 1
  ...
  hi def link vimUnmap	vimCommand
  ...
  hi def link vimSubstPat	SpecialChar
